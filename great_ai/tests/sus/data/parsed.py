...
content = [
    ...
    Paragraph(
        sentences=[
            ...
            Text(
                content="The competences that Dutch medical students need to acquire to provide great-quality palliative care have recently been set out in an educational framework. 19",
                document_order=41,
    ...
    Paragraph(
        sentences=[
            Text(
                content="And what might also be great timing,(…), is the second half of the third year of medicine.",
                document_order=181,
